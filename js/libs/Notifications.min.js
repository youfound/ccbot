      ...
      628: (t, e, n) => {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    new Promise(function (o) {
                      setTimeout(function () {
                        e.classList.add(p.klass.hiding),
          ...
          function a(t, e, n, o) {
            ...
            return (
              ...
              (r = i.call(
                ...
                ''.concat(l.prefix, ' ').concat(l.prefix, '-').concat(e),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    var e = Array.from(
                      this.parent.getElementsByClassName(l.prefix)
                    );
                    this.delete(
                      e.find(function (e) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      this.addEvent(o, function () {
                        t.isDeleted() ||
                          (t.toggleClass(l.klass.progressBarPause),
                          t.timer.toggle());
                      });
                    }
                  }
        ...
        var P = (function (t) {
          ...
          function a(t) {
            ...
            return (
              ((e = i.call(this, document.body, f.ids.wrapper, null, s, o))[
                f.ids.confirmOk
              ] = r),
              (e[f.ids.confirmCancel] = c),
              (e.className = ''.concat(f.prefix, '-').concat(n)),
                ...
                value: function (t) {
                  ...
                  switch (this.type) {
                    case 'confirm':
                      var n = [
                        "<button class='"
                          .concat(f.klass.button, ' ')
                          .concat(f.klass.successBtn, "'id='")
                          .concat(f.ids.confirmOk, "'>")
                          .concat(this.options.labels.confirmOk, '</button>'),
                      ];
                      !1 !== this[f.ids.confirmCancel] &&
                        n.push(
                          "<button class='"
                            .concat(f.klass.button, ' ')
                            .concat(f.klass.cancelBtn, "'id='")
                            .concat(f.ids.confirmCancel, "'>")
                            .concat(
                        ...
                        (e = ''
                          ...
                          .concat(f.klass.title, "'>")
                          .concat(
                            this.options.label(this.type),
                            '</div><div class="'
                          )
                          .concat(f.klass.content, '">')
                          .concat(e, "</div><div class='")
                          .concat(f.klass.buttons, ' ')
                          .concat(f.klass.buttons, '-')
                          .concat(n.length, "'>")
                          .concat(n.join(''), '</div>'));
                      break;
                    case 'async-block':
                      e = ''
                        .concat(e, '<div class="')
                        .concat(f.klass.dotAnimation, '"></div>');
                  }
                ...
                value: function (t) {
                  ...
                  switch (t.code) {
                    ...
                    case 'Tab':
                      ...
                      var e = this.okBtn;
                      t.shiftKey
                        ? document.activeElement.id == f.ids.confirmOk &&
                          (e = this.cancelBtn)
                        : document.activeElement.id !== f.ids.confirmCancel &&
                          (e = this.cancelBtn),
                        e.focus();
                  }
                },
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                get: function () {
                  return (
                    document.getElementById(l.ids.container) ||
